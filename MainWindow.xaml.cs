...
namespace CopyFilesInOneFolder
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private List<FileEntry> excelFileList = new List<FileEntry>();
        ...
        { 
            ...
            try
            {
                ...
                foreach(FileInfo f in Dir.GetFiles("*.rar")) //查找文件
                {
                    excelFileList.Add(new FileEntry { Name = f.Name, Path = f.FullName, IsSelected = true, Status = "未处理" });
                }
            }
            catch(Exception e)
            {
        ...
        {
            bool isOk = Worker.merge(selectedPath, excelFileList, backgroundWorker);
        ...
        private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else if (e.Error != null)
            {
                ...
                MessageBox.Show(e.Error.Message, "错误发生");
            }
            else
            {
